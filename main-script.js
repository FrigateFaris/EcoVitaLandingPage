...
const translations = {
  ru: {
    ...
    hero_eyebrow:"ECOVITA · с 1998 года", hero_h1:"Качество, проверенное временем",
    hero_p:"БАДы ECOVITA — тщательный выбор ингредиентов и производства по всему миру.",
    hero_scroll:"скролль вниз",
    hero_hist_a_p:"Международный бренд витаминов и БАД, основанный в 1998 году. Мы собираем лучшие ингредиенты со всего мира и разрабатываем формулы с учётом климата и потребностей каждого рынка.",
    hero_hist_quote:"Лучший ингредиент — там, где он лучший.<br>Артишок — из Индии. Омега-3 — из России.<span class=\"mark close\">&rdquo;</span>",
    hist_year:"1998", hist_today:"сегодня", hist_principle:"Принцип ECOVITA", formula_label:"ФОРМУЛА",
    ...
    hist_p1:"<strong>ECOVITA</strong> — международный бренд витаминов и БАД, основанный в 1998 году. Начав с ограниченной линейки продукции, компания последовательно расширяла ассортимент, опираясь на глубокое изучение рынка сырья по всему миру — в том числе с применением современных ИИ-инструментов анализа.",
    hist_p2:"Философия бренда проста: <strong>лучший ингредиент берётся там, где он лучший</strong> — будь то Индия, США, Китай или другие страны. ECOVITA выбирает производственные площадки по всему миру и разрабатывает формулы с учётом климата, особенностей рынка и запросов потребителей — включая Узбекистан, где мы отдельно адаптируем дозировки и состав под местные предпочтения.",
    ...
    src1_title:"Артишок — Индия", src1_desc:"Экстракт для поддержки печени и пищеварения",
    src2_title:"Адаптация — Узбекистан", src2_desc:"Дозировки и состав под предпочтения местного рынка",
    src3_title:"Омега-3 — Россия", src3_desc:"Концентрат рыбьего жира высокой степени очистки",
  ...
  uz: {
    ...
    hero_eyebrow:"ECOVITA · 1998 yildan", hero_h1:"Vaqt sinovidan oʻtgan sifat",
    ...
    hero_hist_a_p:"1998 yilda asos solingan xalqaro vitaminlar va BAD'lar brendi. Biz butun dunyodan eng yaxshi ingredientlarni tanlaymiz va har bir bozorning iqlimi hamda ehtiyojlarini hisobga olib formulalar ishlab chiqamiz.",
    hero_hist_quote:"Eng yaxshi ingredient — u eng yaxshi boʻlgan joydan.<br>Artishok — Hindistondan. Omega-3 — Rossiyadan.<span class=\"mark close\">&rdquo;</span>",
    hist_year:"1998", hist_today:"bugun", hist_principle:"ECOVITA tamoyili", formula_label:"FORMULA",
    ...
    hist_p1:"<strong>ECOVITA</strong> — 1998 yilda asos solingan xalqaro vitaminlar va BAD'lar brendi. Cheklangan mahsulot toʻplamidan boshlab, kompaniya butun dunyo xomashyo bozorini chuqur oʻrganish asosida assortimentni izchil kengaytirdi — jumladan zamonaviy sun'iy intellekt vositalaridan foydalanib.",
    hist_p2:"Brend falsafasi sodda: <strong>eng yaxshi ingredient u eng yaxshi boʻlgan joydan olinadi</strong> — Hindiston, AQSH, Xitoy yoki boshqa davlatlardan. ECOVITA butun dunyo boʻylab ishlab chiqarish maydonchalarini tanlaydi va iqlim, bozor xususiyatlari hamda isteʼmolchilar ehtiyojlarini hisobga olib formulalar ishlab chiqadi — jumladan Oʻzbekiston, bu yerda biz doza va tarkibni mahalliy afzalliklarga alohida moslashtiramiz.",
    ...
    src1_title:"Artishok — Hindiston", src1_desc:"Jigar va ovqat hazm qilishni qoʻllab-quvvatlash uchun ekstrakt",
    src2_title:"Moslashuv — Oʻzbekiston", src2_desc:"Mahalliy bozor afzalliklariga moslashtirilgan doza va tarkib",
    src3_title:"Omega-3 — Rossiya", src3_desc:"Yuqori tozalikdagi baliq yogʻi konsentrati",
...
const fcProducts = {
  ...
  uz: [
    ...
    { img:'collagen.webp', name:'Collagen Type I-III', dose:'430 MG · 60 CAPS', cat:'beauty', desc:'Teri, bogʻimlar va immunitet uchun kollagen.', bullets:['Teri salomatligini yaxshilaydi','Xaftaga toʻqimasini tiklashga yordam beradi'], detail:'I–III turdagi kollagen teri elastikligi va namligini, soch hamda tirnoqlar mustahkamligini qoʻllab-quvvatlaydi, bogʻim xaftaga toʻqimasini tiklashga yordam beradi va immunitetni mustahkamlaydi.' },
    { img:'vitamin-d3-2000.webp', name:'Vitamin D3 2000 ME', dose:'2000 ME · 100 CAPS', cat:'beauty', desc:'Immunitet va asab tizimi uchun D3 vitamini.', bullets:['Umumiy immunitetni oshirishga yordam beradi','Asab tizimini tiklaydi'], detail:'2000 ME dozadagi D3 vitamini immunitetni, kaltsiy singishini, asab tizimi tiklanishini va mushak tonusini qoʻllab-quvvatlaydi.' },
    { img:'vitamin-d3-5000.webp', name:'Vitamin D3 5000 ME', dose:'5000 ME · 100 CAPS', cat:'beauty', desc:'Kuchaytirilgan D3 vitamini dozasi.', bullets:['Umumiy immunitetni oshirishga yordam beradi','Asab tizimini tiklaydi'], detail:'5000 ME dozadagi D3 vitamini quyosh yetishmasligi davrida qoʻshimcha immunitet yordamiga muhtoj boʻlganlar uchun kuchaytirilgan formula.' },
    { img:'vitamin-d3-10000.webp', name:'Vitamin D3 10000 ME', dose:'10000 ME · 100 CAPS', cat:'beauty', desc:'D3 vitaminining maksimal dozasi.', bullets:['Umumiy immunitetni oshirishga yordam beradi','Asab tizimini tiklaydi'], detail:'10000 ME yuqori dozadagi D3 vitamini mutaxassis nazorati ostida jiddiy D vitamin taqchilligini toʻldirish uchun moʻljallangan.' },
    { img:'vitamin-d3-k2.webp', name:'Vitamin D3 + K2', dose:'2000 ME · 50 MCG · 100 CAPS', cat:'beauty', desc:'Suyak va tomirlar uchun D3 va K2 kombinatsiyasi.', bullets:['Asab tizimini tiklaydi','Immunitetni oshirishga yordam beradi'], detail:'D3 va K2 vitaminlari kombinatsiyasi kaltsiyning suyak toʻqimasiga yoʻnalishini kuchaytiradi, immunitet va asab tizimini qoʻllab-quvvatlaydi.' },
    { img:'folic-acid.webp', name:'Folic Acid', dose:'400 MCG · 60 CAPS', cat:'beauty', desc:'Gormonal muvozanat uchun folat kislotasi.', bullets:['Gormonal muvozanat','Asab tizimini qoʻllab-quvvatlash'], detail:'Folat kislotasi (B9 vitamini) hujayra boʻlinishida ishtirok etadi, gormonal muvozanatni, asab tizimi va reproduktiv funksiyani qoʻllab-quvvatlaydi.' },
    { img:'glucosamine-chondroitin-msm.webp', name:'Glucosamine Chondroitin MSM', dose:'2320 MG · 120 CAPS', cat:'bones', desc:'Bogʻimlar harakatchanligi uchun kompleks.', bullets:['Bogʻimlar harakatchanligini oshiradi, ogʻriqni kamaytiradi','Toʻqimalar tiklanishini rag\u02bbbatlantiradi'], detail:'Glyukozamin, xondroitin va MSM kompleksi bogʻim salomatligi uchun klassik formula — ogʻriqni kamaytiradi, harakatchanlikni oshiradi va xaftaga toʻqimasi tiklanishini rag\u02bbbatlantiradi.' },
...
function fcImageSrc(product){
  // The catalog grid uses a separately-optimized thumbnail: "name-full.webp"
  // (the zoomed/detail image) maps to "name.webp" (the small thumbnail).
  if (product.image && product.image.startsWith('assets/products/')){
    const fileName = product.image.split('/').pop().replace(/-full\.webp$/i, '.webp').replace(/\.(png|jpe?g)$/i, '.webp');
...
const showcaseProducts = {
  ru: [
    { formula:'01', tab:'Magnesium + B6', eyebrow:'МАГНИЙ + B6', headline:'Спокойствие. Сон. Баланс.', desc:'Магний с витамином B6 поддерживает нервную систему, снижает стресс и улучшает качество сна.', img:'assets/products/mag-b6-60-v2.webp' },
    { formula:'02', tab:"Lion's Mane", eyebrow:'ЛЬВИНАЯ ГРИВА', headline:'Фокус. Память. Спокойствие.', desc:'Ежовик гребенчатый способствует ясности ума, улучшает концентрацию и поддерживает память.', img:'assets/products/lions-mane-90.webp' },
    { formula:'03', tab:'Glucosamine', eyebrow:'ГЛЮКОЗАМИН', headline:'Суставы. Подвижность. Восстановление.', desc:'Глюкозамин, хондроитин и MSM способствуют уменьшению боли и увеличению подвижности суставов.', img:'assets/products/gcm-120.webp' },
  ],
  uz: [
    { formula:'01', tab:'Magnesium + B6', eyebrow:'MAGNIY + B6', headline:'Xotirjamlik. Uyqu. Muvozanat.', desc:'B6 vitaminli magniy asab tizimini qo\u02bbllab-quvvatlaydi, stressni kamaytiradi va uyqu sifatini yaxshilaydi.', img:'assets/products/mag-b6-60-v2.webp' },
    { formula:'02', tab:"Lion's Mane", eyebrow:'SHER YOLI', headline:'Diqqat. Xotira. Xotirjamlik.', desc:'Kirpiksimon qo\u02bbziqorin ong ravshanligiga yordam beradi, diqqatni yaxshilaydi va xotirani qo\u02bblab-quvvatlaydi.', img:'assets/products/lions-mane-90.webp' },
    { formula:'03', tab:'Glucosamine', eyebrow:'GLYUKOZAMIN', headline:'Bo\u02bbg\u02bbimlar. Harakatchanlik. Tiklanish.', desc:'Glyukozamin, xondroitin va MSM og\u02bbriqni kamaytirish va bo\u02bbg\u02bbimlar harakatchanligini oshirishga yordam beradi.', img:'assets/products/gcm-120.webp' },
  ]
};
let showcaseIndex = 0;
